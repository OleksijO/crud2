...
import static crud1.utils.Helper.*;
...
public class Start extends AbstractPageTemplate {
    ...
    public void showBody() {
        print("Main implemented features in this project  are:");
        print("<br>");
        ...
        print("<br>");
        print("<br>");
        printCenter(href("https://github.com/OleksijO/crud1/", "Application sources here.."));
        print("<br>");
